...
cd "$ROOT_DIR"
CONFIG_PATH="test/performance-model-tests/configs/execute_int_div_latency.toml"
ELF_PATH="test/performance-model-tests/binaries/execute_int_div_latency.elf"
