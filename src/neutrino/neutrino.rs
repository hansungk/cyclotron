...
use crate::neutrino::scoreboard::{
    NeutrinoCmd, NeutrinoCmdType, NeutrinoPartMode, NeutrinoRetMode, Scoreboard,
};
...
impl Neutrino {
    ...
    pub fn execute(
        ...
        info!(
            "{} has job id {} written to x{}",
            cmd, job_id_u32, issued.rd_addr
        );
    }
